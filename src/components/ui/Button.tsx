      ...
      <button
        ...
        className={cn(
          'inline-flex items-center justify-center gap-2 font-bold rounded-xl transition-all duration-200 cursor-pointer active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed',
          {
            ...
            'bg-gradient-to-br from-red-700 to-red-600 text-white shadow-[0_4px_20px_rgba(185,28,28,0.35)] hover:shadow-[0_10px_40px_rgba(185,28,28,0.5)] hover:-translate-y-0.5': variant === 'danger',
          },
          {
